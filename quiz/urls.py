...
urlpatterns = [
    ...
    #path('login/', login,  name='login_profile'),
    #path('logout/', login,  name='logout_profile'),
    path('register/', register,  name='register_profile'),

    path('login/', auth_views.LoginView.as_view(template_name='login.html'), name='login_profile'),
    path('logout/', auth_views.LogoutView.as_view(template_name='logout.html'), name='logout_profile'),
